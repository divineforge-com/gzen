...
;(function () {
  ...
  function solar2Lunar(y, m, d) {
    ...
    if (offset < 0) {
      offset += leapFlag ? leapDays(lunarYear) : monthDays(lunarYear, lunarMonth)
      --lunarMonth
    }
  ...
  function hexToRgba(hex, alpha) {
    ...
    if (isNaN(r)) {
      return FALLBACK_PARTICLE_RGBA + alpha + ")"
    }
  ...
  var UI_STRINGS = {
    zh: {
      ...
      fullMoon: " · 满月 🌕",
      newMoon: " · 新月 🌑",
      monthInfo: function (m) {
        return "农历 · 第" + m + "月 · 聚善"
      }
    },
    en: {
      preview: function (d) {
        return "Preview · Day " + d
      },
      dayLabel: function (d) {
        return "Lunar Day " + d
      },
