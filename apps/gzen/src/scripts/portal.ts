...
const ELEMENT_CONFIG = {
  Z: {
    ...
    tone: "#2d6b4f",
    secondary: "#1e4a36",
    glow: "rgba(45, 107, 79, 0.16)",
    cursorGlow: "rgba(45, 107, 79, 0.08)",
    audioFreq: 432,
    subFreq: 216,
  ...
  N: {
    ...
    tone: "#d97845",
    secondary: "#c2410c",
    glow: "rgba(217, 120, 69, 0.16)",
    cursorGlow: "rgba(217, 120, 69, 0.08)",
    audioFreq: 741,
    subFreq: 370.5,
    waveform: "triangle" as OscillatorType,
  },
...
/**
 * 14. Removed legacy BuyMeACoffee controller
 */
